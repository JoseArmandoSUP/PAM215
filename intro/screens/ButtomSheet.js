    ...
    <GestureHandlerRootView style={styles.rootView}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.productosContainer}>
          ...
          <Image style={styles.imagenTenis} 
            source={{uri:'https://dpjye2wk9gi5z.cloudfront.net/wcsstore/ExtendedSitesCatalogAssetStore/images/catalog/default/1036316-0000V1.jpg'}}
          ></Image>
      ...
      >
        <BottomSheetView style={styles.BView}>
          ...
          <Text style={styles.sheetTitle}>Realizar el pago</Text>
          <Text style={styles.sheetText}>Total a pagar: $150</Text>

          <View>
            <TouchableOpacity style={styles.buttonPagar} onPress={()=>alert('Copra Realizada')}>
